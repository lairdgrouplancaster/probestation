# probestation
Python code for the custom automated probestation in the labs of Laird group at Lancaster University (EverBeing C4 probestation with Standa motorized X/Y and Z translation stages).
